    ...
    return (
        <div className="flex flex-col items-center mt-6 lg:mt-20">
            <h1 className="text-4xl sm:text-6xl lg:text-7xl text-center tracking-wide">
                VirtuelR build tools
                {" "}
                <span className="bg-gradient-to-r from-orange-400 to-orange-800 text-transparent bg-clip-text">for developers</span>
            </h1>
            ...
            <div className="flex my-10 justify-center">
                <video autoPlay loop muted className="w-1/2 mx-2 my-4 border border-orange-500 rounded-lg">
